...
from app.config import (
    CUSTOMERS_FILE, GEOLOCATION_FILE, ITEMS_FILE, ORDERS_FILE, PAYMENTS_FILE, PRODUCTS_FILE,
...
def load_payments(datasets_dir: Path) -> pd.DataFrame:
    return pd.read_csv(
        datasets_dir / PAYMENTS_FILE,
