...
- After changing `AI/app`, run `.claude/hooks/package-python.ps1` and copy `AI/app` over `Java/OpportunityApp/config/py/mosaic/app`. Never copy `AI/models` there: those models are trained on the site's own CSV export.
