...
/**
 * Sign-in and sign-up frame: a vivid periwinkle panel with the Valora
 * illustration, and the form in a white card on the right.
 */
export function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen bg-page p-2 sm:p-4">
      <div className="relative flex min-h-[calc(100vh-1rem)] flex-col overflow-hidden rounded-[28px] lg:rounded-bl-none bg-[#5b63f5] text-white sm:min-h-[calc(100vh-2rem)]">
        ...
        <div className="flex flex-1 items-center gap-6 px-4 pb-10 sm:px-10 lg:items-stretch lg:gap-4 lg:pb-[96px]">
          ...
          <div className="mx-auto flex w-full max-w-[460px] shrink-0 items-center lg:mx-0">
            <div className="fade-up w-full rounded-2xl bg-surface p-6 text-ink shadow-[0_24px_60px_-24px_rgba(20,22,80,0.55)] sm:p-7">
              {children}
            </div>
          </div>
        </div>
