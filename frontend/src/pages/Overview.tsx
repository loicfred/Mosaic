...
function NextStep({ o }: { o?: Opportunity }) {
  ...
  return (
    <section
      ...
      className="flex flex-col rounded-[20px] bg-[#1b2a4e] bg-[linear-gradient(150deg,#2a3f6e_0%,#1b2a4e_55%,#14213d_100%)] p-6 text-white shadow-[0_18px_40px_-24px_rgba(15,26,51,0.9)]"
    >
      ...
      <div className="mt-auto flex flex-col gap-2 pt-6">
        <Link
          ...
          className="flex h-11 items-center justify-center gap-2 rounded-xl bg-white text-[15px] font-semibold text-[#1b2a4e] transition-colors hover:bg-periwinkle-50"
        >
          See what to do <ArrowRight className="size-4" aria-hidden />
        </Link>
        <Link
          to="/scenarios"
          className="flex h-11 items-center justify-center gap-2 rounded-xl text-[15px] font-medium text-white ring-1 ring-inset ring-white/70 bg-[#0b8193] transition-colors hover:bg-[#086877]"
        >
